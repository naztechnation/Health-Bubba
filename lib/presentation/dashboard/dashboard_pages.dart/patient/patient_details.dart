                            ...
                            child: SizedBox(
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Container(
                                      margin: const EdgeInsets.fromLTRB(0.3, 0, 0, 16),
                                      child: ClipRRect(
                                        borderRadius: BorderRadius.circular(40),
                                        child: const SizedBox(
                                          width: 62.6,
                                          height: 64,
                                          child: ImageView.asset(AppImages.onboardingOne, fit: BoxFit.cover,)
                                        ),
                                      ),
                                    ),
                                    Text(
                          ...
                          child: Row(
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  Container(
                                    margin: const EdgeInsets.fromLTRB(0, 11, 6, 11),
                                    width: 20,
                                    height: 20,
                                    child: const SizedBox(
                                      width: 20,
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        margin: const EdgeInsets.fromLTRB(0, 0, 11.8, 0),
                                        child: Text(
                                          '24',
                                          style: GoogleFonts.getFont(
                                            'Inter',
                              ...
                              Row(
                                ...
                                children: [
                                  Container(
                                    margin: const EdgeInsets.fromLTRB(0, 12.7, 6, 12.7),
                                    width: 20,
                                    height: 20,
                                    child: const SizedBox(
                                      width: 20,
                                      height: 20,
                                      child:  ImageView.svg(AppImages.weightIcon),
                                    ),
                                  ),
                                  Column(
                                    mainAxisAlignment: MainAxisAlignment.start,
                              ...
                              Row(
                                ...
                                children: [
                                  Container(
                                    margin: const EdgeInsets.fromLTRB(0, 13.2, 6, 12.6),
                                    width: 20,
                                    height: 20,
                                    child: const SizedBox(
                                      width: 20,
                                      height: 20,
                                      child: ImageView.svg(AppImages.genderIcon),
                                    ),
                                  ),
                                  Column(
                                    mainAxisAlignment: MainAxisAlignment.start,
