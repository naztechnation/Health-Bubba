...
class AppointmentTabViewScreen extends StatefulWidget {
  ...
  @override
  State<AppointmentTabViewScreen> createState() => _AppointmentTabViewScreenState();
}
        ...
        actions: [
          GestureDetector(
            onTap: () {
              ...
              page: SearchPage(appointment: 
              
              (upComing) ? upcomingAppointment : (completed) ? completedAppointment : (cancelled) ? cancelledAppointment : upcomingAppointment
           ...
           Expanded(
             child: SingleChildScrollView(
               child: Column(children: [
                 if (upComing)
                    UpcomingPage(upcomingAppointment: upcomingAppointment,)
                else if (completed)
                  CompletedPage(completedAppointment: completedAppointment,)
                else if (cancelled)
                  CancelledPage(cancelledAppointment: cancelledAppointment,)
               ],),
             ),
           )
          ],
