...
class ReschedulePage extends StatelessWidget {
  ...
  final AppointmentListsData appointment;
   const ReschedulePage(
      {super.key, required this.isSchedule, required this.appointment, required this.isDue});
  @override
  Widget build(BuildContext context) {
    return BlocProvider<UserCubit>(
      ...
      child:   Reschedule(isSchedule: isSchedule, appointment: appointment, isDue: isDue,),
    );
  }
}
...
class _RescheduleState extends State<Reschedule> {
  ...
  void initState() {
    ...
    _userCubit.getAppointmentDetails(appointmentId: widget.appointment.appointmentId.toString());
  }
  @override
  Widget build(BuildContext context) {
    return BlocConsumer<UserCubit, UserStates>(listener: (context, state) {
        ...
        appBar: AppBar(
          title: Center(
            child: Text(
              (widget.isSchedule) ? 'Appointment' : widget.appointment.patientFirstName ?? '',
                ...
                children: [
                  Container(
                    ...
                    child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    AppUtils.formatTimeOnly(
                                        dateTime: widget.appointment.time ?? ''),
                                    style: GoogleFonts.getFont(
                                      'Inter',
                                      fontWeight: FontWeight.w500,
                                      fontSize: 14,
                          ...
                          GestureDetector(
                            onTap: () {
                              AppNavigator.pushAndStackPage(context,
                                  page: PatientImages(
                                    patientImages: widget.appointment.images ?? [],
                                  ));
                            },
                            child: Padding(
                              padding:
                                  ...
                                  Stack(
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: Image.network(
                                          fit: BoxFit.cover,
                                          widget.appointment.patientPicture ?? '',
                                          errorBuilder:
                      ...
                      (appointmentDetails?.healthConditions == null) ? const SizedBox.shrink(): Container(
                          decoration: const BoxDecoration(
                            color: Color(0xFFFFFFFF),
                            border: Border(
                              bottom: BorderSide(
        ...
        bottomNavigationBar: (!widget.isDue) ? Container(
          decoration: const BoxDecoration(
            color: Color(0xFFFFFFFF),
            border: Border(
              top: BorderSide(
