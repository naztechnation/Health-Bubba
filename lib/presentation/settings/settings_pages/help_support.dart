            ...
            child: Column(
              ...
              children: [
                ...
                ListTile(
                  ...
                  onTap: () {
                     openWhatsApp(phone: "+2349163324000");
                  },
                ...
                ListTile(
                  onTap: () {
                    ...
                    _launchUrl("https://chat.whatsapp.com/KNHgrpazp5PHF2N498W6PW");
                  },
                  leading: const SizedBox(
                      width: 17.9,
                      height: 17.9,
                  ...
                  subtitle: Container(
                    ...
                    margin:   EdgeInsets.only(right: MediaQuery.sizeOf(context).width * 0.3, top: 15),
                    padding:
                ...
                Divider(
                 ...
                 ListTile(
                  ...
                  onTap: () {
                    _launchUrl("https://www.instagram.com/healthbubba/?igsh=ZmMyOXJ1a3hpZTZh#");
                  },
                ),
                const SizedBox(height: 10,),
                Divider(
               ...
               const SizedBox(height: 10,),
                 ListTile(
                  ...
                  onTap: () async{
                   ...
                   await launchUrl(Uri.parse("mailto:info@healthbubba.com?subject=subject&body=body"));
                  },
