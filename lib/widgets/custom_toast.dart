    ...
    return Container(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: AppColors.lightPrimary, // Replace with your color
          borderRadius: BorderRadius.circular(8.0),
        ),
        child: Row(
          ...
          children: [
                ...
                children: [
                  Text(
                    ...
                    style: const TextStyle(
                      color: AppColors.lightSecondary, // Replace with your color
                  ...
                  Text(
                    ...
                    style: const TextStyle(color: Color(0xFF4B5563), fontSize: 13, fontWeight: FontWeight.w400),
                  ),
                ],
              ),
            ),
            const SizedBox(width: 10.0),
              ...
              Container(height: 80, width: 0.5,color: Colors.grey.shade300,),
            const SizedBox(width: 10.0),
